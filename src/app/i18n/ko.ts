...
export const ko = {
  ...
  settings: {
    ...
    deviceWorking: '처리 중…',
    deviceNoPort: '디바이스를 찾을 수 없습니다. 먼저 온보드 USB 포트에 케이블을 연결해 주세요',
    deviceEmpty: '디바이스를 찾을 수 없습니다. 케이블을 온보드 USB 포트(TinyUSB CDC, VID 303A / PID 1001)에 연결하세요. CH340 플래싱 포트는 연결에 사용할 수 없습니다.',
    deviceRefresh: '다시 검색',
    deviceNeedConnect: '여기서 설정하려면 먼저 위에서 USB로 연결해 주세요',
    deviceUnsupported: '연결되었지만 현재 펌웨어에서는 이 기능을 지원하지 않습니다',
    deviceTheme: '디바이스 테마',
    deviceThemeHint: '즉시 적용하고 디바이스에 저장합니다',
    deviceThemeNames: { custom: '사용자 지정(현재)', ocean: '오션', midnight: '미드나이트', light: '라이트', whale_mad: '고래 Mad' },
