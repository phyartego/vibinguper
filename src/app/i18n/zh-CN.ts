...
export const zhCN = {
  ...
  settings: {
    ...
    disconnectDevice: '断开',
    deviceWorking: '处理中…',
    deviceNoPort: '未发现下位机，请先用数据线接好板载 USB 口',
    deviceEmpty: '未发现下位机。请把数据线插到板载 USB 口（TinyUSB CDC，VID 303A / PID 1001）；CH340 烧录口无法用于连接。',
    deviceRefresh: '重新扫描',
    deviceNeedConnect: '需先在上方通过 USB 连接下位机，才能在此配置',
    deviceUnsupported: '已连接，但当前固件未开放此功能',
    deviceTheme: '下位机主题',
    deviceThemeHint: '立即写入并持久化到下位机',
    deviceThemeNames: { custom: '自定义（当前）', ocean: '海洋蓝', midnight: '午夜黑', light: '浅色', whale_mad: '鲸鱼 Mad' },
    swipeLeft: '触摸板左滑',
    swipeRight: '触摸板右滑',
