...
export const zhTW = {
  ...
  settings: {
    ...
    disconnectDevice: '中斷',
    deviceWorking: '處理中…',
    deviceNoPort: '未發現下位機，請先用傳輸線接好板載 USB 埠',
    deviceEmpty: '未發現下位機。請將傳輸線插到板載 USB 埠（TinyUSB CDC，VID 303A / PID 1001）；CH340 燒錄埠無法用於連線。',
    deviceRefresh: '重新掃描',
    deviceNeedConnect: '需先在上方透過 USB 連線下位機，才能在此設定',
    deviceUnsupported: '已連線，但目前韌體未開放此功能',
    deviceTheme: '下位機主題',
    deviceThemeHint: '立即套用並儲存於下位機',
    deviceThemeNames: { custom: '自訂（目前）', ocean: '海洋藍', midnight: '午夜黑', light: '淺色', whale_mad: '鯨魚 Mad' },
    swipeLeft: '觸控板左滑',
    swipeRight: '觸控板右滑',
