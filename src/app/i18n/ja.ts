...
export const ja = {
  ...
  settings: {
    ...
    disconnectDevice: '切断',
    deviceWorking: '処理中…',
    deviceNoPort: 'デバイスが見つかりません。先にオンボード USB ポートを接続してください',
    deviceEmpty: 'デバイスが見つかりません。ケーブルをオンボード USB ポート（TinyUSB CDC、VID 303A / PID 1001）に接続してください。CH340 書き込みポートは接続に使えません。',
    deviceRefresh: '再スキャン',
    deviceNeedConnect: 'ここで設定するには、まず上で USB 接続を完了してください',
    deviceUnsupported: '接続済みですが、現在のファームウェアではこの機能を利用できません',
    deviceTheme: 'デバイステーマ',
    deviceThemeHint: 'デバイスへ即時適用して保存します',
    deviceThemeNames: { custom: 'カスタム（現在）', ocean: 'オーシャン', midnight: 'ミッドナイト', light: 'ライト', whale_mad: 'クジラ Mad' },
