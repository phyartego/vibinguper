...
export const en = {
  ...
  settings: {
    ...
    deviceNoPort: 'No device found — plug the cable into the onboard USB port first',
    deviceEmpty: 'No device found. Plug the cable into the onboard USB port (TinyUSB CDC, VID 303A / PID 1001); the CH340 flashing port cannot be used.',
    deviceRefresh: 'Rescan',
    deviceNeedConnect: 'Connect the device over USB above to configure it here',
    deviceUnsupported: 'Connected, but the current firmware does not expose this feature',
    deviceTheme: 'Device theme',
    deviceThemeHint: 'Applied immediately and stored on the device',
    deviceThemeNames: { custom: 'Custom (current)', ocean: 'Ocean', midnight: 'Midnight', light: 'Light', whale_mad: 'Whale Mad' },
